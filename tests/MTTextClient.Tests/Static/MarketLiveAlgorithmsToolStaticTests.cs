...
/// <summary>
/// Static declaration checks for the mt_market_live_algorithms tool: it is
/// registered with the expected argument surface and, being a read-only query,
/// is not confirm-gated. Catalog/snapshot/README parity for the tool is covered
/// by the existing DispatcherSnapshotTests / ReadmeParityTests / ToolCatalog.
/// </summary>
