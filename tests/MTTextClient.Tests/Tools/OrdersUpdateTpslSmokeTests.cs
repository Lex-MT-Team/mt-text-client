...
/// <summary>
/// Smoke coverage for the <c>mt_orders_update_tpsl</c> tool.  Real fill +
/// TP/SL attach is exercised in
/// <see cref="LiveTrade.OrdersUpdateTpslLiveTradeTests"/>.
///
...
public sealed class OrdersUpdateTpslSmokeTests
{
    private readonly McpFixture _mcp;
    private readonly BenchFixture _bench;
    public OrdersUpdateTpslSmokeTests(McpFixture mcp, BenchFixture bench) { _mcp = mcp; _bench = bench; }
